...
import { GrpcWebImpl, Relationship, RelationshipRequest, RelationshipServiceClientImpl } from "./generated/relationship";
...
export function getRelationships(nodeId: string): Observable<Relationship> {
    ...
    const request: RelationshipRequest = { nodeId: nodeId };
